	...
	app: {
		head: {
			...
			meta: [
				...
				{ name: 'description', content: 'Using CSS gradient text, you can generate beautiful gradient text using CSS, modify it (change colors - angle), then simply copy-paste it into your code' },
				...
				{ property: 'og:description', content: 'Using CSS gradient text, you can generate beautiful gradient text using CSS, modify it (change colors - angle), then simply copy-paste it into your code' },
				...
				{ property: 'twitter:description', content: 'Using CSS gradient text, you can generate beautiful gradient text using CSS, modify it (change colors - angle), then simply copy-paste it into your code' },
